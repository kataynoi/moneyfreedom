...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> กลุ่มรายงาน
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">เพิ่มกลุ่มรายงาน</h4>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_report_group.js" charset="utf-8"></script>
