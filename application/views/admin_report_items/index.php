...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> รายการรายงาน
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">เพิ่มรายการรายงาน</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="id" placeholder="" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="group" placeholder="กลุ่มรายงาน" value="">
                        <option>-------</option>
                        <?php
                        foreach ($creport_group as $r) {
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_report_items.js" charset="utf-8"></script>
