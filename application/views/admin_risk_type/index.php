...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> ประเภทความเสี่ยง
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">เพิ่มประเภทความเสี่ยง</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name">ประเภทความเสี่ยง</label>
                    <input type="text" class="form-control" id="name" placeholder="ประเภทความเสี่ยง" value=""></div>
            </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_risk_type.js" charset="utf-8"></script>
