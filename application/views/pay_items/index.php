        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="ชื่อรายการ" value=""></div>
                <div class="form-group">
                    <label for="price">ราคา</label>
                    <input type="text" class="form-control" id="price" placeholder="ราคา" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="date" class="form-control datepicker" data-date-format="mm/dd/yyyy"></div>
