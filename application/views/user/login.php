            ...
            <div class="col-md-6">
                <section class="login-form">
                    <form method="post" action="#" role="login" id="frm_login">
                        ...
                        <input type="password" class="form-control input-lg" id="pin">
                    </form method="post">
                    <button name="go" class=" btn btn-lg  btn-block w3-theme-d1" style="font-size: 100px"
                        id="btn_login">OK</button>
                    <div>
