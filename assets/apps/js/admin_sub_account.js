$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_sub_account/fetch_admin_sub_account',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_sub_account/del_admin_sub_account',
            params = {
                id: id
            }
        ...
        var url = '/admin_sub_account/save_admin_sub_account',
            params = {
                items: items
            }
        ...
        var url = '/admin_sub_account/get_admin_sub_account',
            params = {
                id: id
            }
...
crud.set_after_update = function (items, row_id) {
    ...
    row_id.find("td:eq(2)").html(items.account_id);
    row_id.find("td:eq(3)").html(items.limit);
...
crud.set_after_insert = function (items, id) {
    ...
    $('<tr name="row' + (id + 1) + '"><td>' + id + '</td>' +
        '<td>' + items.id + '</td>' + '<td>' + items.name + '</td>' + '<td>' + items.account_id + '</td>' + '<td>' + items.limit + '</td>' + '<td>' + items.active + '</td>' +
